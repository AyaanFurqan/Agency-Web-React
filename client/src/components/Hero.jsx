        ...
        <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12
         lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
            ...
            <p className='text-sm sm:text-lg font-medium text-gray-500
             ...
             Creating meaningful connections and turning 
             big ideas into interactive digital experinces.
            </p>

            <div className='relative'>
                <img className='w-full max-w-6xl' src={assets.hero_img} alt="" />
                <img className='absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden
                 ' src={assets.bgImage1} alt="" />
            </div>
