            ...
            <div className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input className='w-full p-3 text-sm outline-none' type="text" placeholder='Enter your name' />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input className='w-full p-3 text-sm outline-none' type="text" placeholder='Enter your email' />
                    </div>
                </div>
